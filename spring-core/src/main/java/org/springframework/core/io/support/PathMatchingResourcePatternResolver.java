...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	protected Set<Resource> doFindAllClassPathResources(String path) throws IOException {
		...
		ClassLoader cl = getClassLoader();//获取当前的classloader，todo 待深入了解
		Enumeration<URL> resourceUrls = (cl != null ? cl.getResources(path) : ClassLoader.getSystemResources(path));//获取根目录的方式
	...
	protected Resource[] findPathMatchingResources(String locationPattern) throws IOException {
		String rootDirPath = determineRootDir(locationPattern);// classpath*:com/john/pojo/**/*.class  classpath*:com/john/pojo/
		String subPattern = locationPattern.substring(rootDirPath.length()); // **/*.class
		Resource[] rootDirResources = getResources(rootDirPath);//是一个绝对路径 rootDirResource
		Set<Resource> result = new LinkedHashSet<>(16);
	 ...
	 * via the Ant-style PathMatcher.
	 * @param rootDirResource the root directory as Resource //  编译后class文件的绝对路径
	 * @param subPattern the sub pattern to match (below the root directory) // "**\/*.class""
	 * @return a mutable Set of matching Resource instances
	 * @throws IOException in case of I/O errors
	 * @see #retrieveMatchingFiles
	 * @see org.springframework.util.PathMatcher
	...
	/**
	 * Recursively retrieve files that match the given pattern, 递归遍历 文件夹 ，
